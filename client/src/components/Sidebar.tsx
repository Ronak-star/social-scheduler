...
import { NavLink, useLocation } from "react-router-dom"; // FIX 1: Link import hata diya — use nahi ho raha tha
  ...
  return (
    ...
    >
      ...
      <div className="px-6 py-2">
        {/* FIX 2: "trackig-wider" → "tracking-wider" */}
      ...
      <div className="p-4 border-t border-slate-100">
        <div className="flex items-center gap-3 p-2 rounded-xl hover:bg-slate-50 transition-colors">
          ...
          {/* FIX 3: Sign out button — flex ke andar properly align karo */}
          <button
            onClick={logout}
            className="p-1.5 rounded hover:bg-red-50 hover:text-red-500 text-slate-400 transition-all duration-150"
            title="Sign Out"
          >
