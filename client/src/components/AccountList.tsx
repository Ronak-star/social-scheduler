  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      {accounts.map((account, index) => {
        ...
        return (
          <div
            key={account._id ?? index}  // ✅ prefer _id over index
          ...
          >
            ...
            <button
              onClick={() => handleDisconnect(account._id)}  // ✅ fixed: account._id
              className="ml-2 p-1.5 rounded-lg text-slate-300 group-hover:text-red-400 transition-colors"
            >
